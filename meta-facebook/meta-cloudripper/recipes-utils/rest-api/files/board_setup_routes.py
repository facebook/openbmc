...
def setup_board_routes(app, write_enabed: bool):
    ...
    app.router.add_get(board_routes[19], bhandler.rest_sensors_psu1_hdl)
    app.router.add_get(board_routes[20], bhandler.rest_sensors_psu2_hdl)
    app.router.add_get(board_routes[21], bhandler.rest_vddcore_get_volt)
    app.router.add_get(board_routes[22], bhandler.rest_vddcore_set_volt)
    app.router.add_get(board_routes[23], bhandler.rest_switch_reset_hdl)
