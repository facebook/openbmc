...
enum {
  ...
  MB_SENSOR_VR_CPU0_VDDQ_ABC_TEMP = 0xBD,
  MB_SENSOR_VR_CPU0_VDDQ_ABC_CURR = 0xBE,
  MB_SENSOR_VR_CPU0_VDDQ_ABC_VOLT = 0xBC,
  MB_SENSOR_VR_CPU0_VDDQ_ABC_POWER = 0xBF,
  MB_SENSOR_VR_CPU0_VDDQ_DEF_TEMP = 0xCD,
  MB_SENSOR_VR_CPU0_VDDQ_DEF_CURR = 0xCE,
  MB_SENSOR_VR_CPU0_VDDQ_DEF_VOLT = 0xCC,
  MB_SENSOR_VR_CPU0_VDDQ_DEF_POWER = 0xCF,
  ...
  MB_SENSOR_VR_CPU1_VDDQ_GHJ_TEMP = 0xFD,
  MB_SENSOR_VR_CPU1_VDDQ_GHJ_CURR = 0xFE,
  MB_SENSOR_VR_CPU1_VDDQ_GHJ_VOLT = 0xFC,
  MB_SENSOR_VR_CPU1_VDDQ_GHJ_POWER = 0xD8,
  MB_SENSOR_VR_CPU1_VDDQ_KLM_TEMP = 0xDA,
  MB_SENSOR_VR_CPU1_VDDQ_KLM_CURR = 0XDB,
  MB_SENSOR_VR_CPU1_VDDQ_KLM_VOLT = 0xD9,
  MB_SENSOR_VR_CPU1_VDDQ_KLM_POWER = 0XDC,
  MB_SENSOR_VR_PCH_PVNN_TEMP = 0xC5,
  MB_SENSOR_VR_PCH_PVNN_CURR = 0xC6,
  MB_SENSOR_VR_PCH_PVNN_VOLT = 0xC4,
  MB_SENSOR_VR_PCH_PVNN_POWER = 0xC7,
};
...
enum {
  VR_CPU0_VCCIN = 0x90,
  VR_CPU0_VCCIO = 0x94,
  VR_CPU0_VDDQ_ABC = 0x1C,
  VR_CPU0_VDDQ_DEF = 0x14,
  VR_CPU1_VCCIN = 0xB0,
  VR_CPU1_VCCIO = 0xB4,
  VR_CPU1_VDDQ_GHJ = 0x0C,
  VR_CPU1_VDDQ_KLM = 0x04,
  VR_PCH_PVNN = 0xD0,
};
