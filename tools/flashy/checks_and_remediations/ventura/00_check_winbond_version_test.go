...
func TestCheckWinbondVersion(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			m_err:        nil,
			version:      "ventura-v2024.46.1-QuantaRelease",
			v_err:        nil,
			want: step.ExitUnsafeToReboot{
				fmt.Errorf("Cannot upgrade this version (ventura-v2024.46.1-QuantaRelease) due to S483584"),
			},
		},
		{
			...
			manufacturer: "winbond",
			m_err:        nil,
			version:      "ventura-v2025.02.1",
			v_err:        nil,
			want: step.ExitUnsafeToReboot{
				fmt.Errorf("Cannot upgrade this version (ventura-v2025.02.1) due to S483584"),
			},
		},
		{
