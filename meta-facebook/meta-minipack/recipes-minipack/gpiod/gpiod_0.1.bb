...
CFLAGS += " -Werror "
LDFLAGS += " -lbic -lminipack_gpio -lpal -llog "

DEPENDS += " libbic libminipack-gpio libpal liblog update-rc.d-native"
RDEPENDS_${PN} += " libbic libminipack-gpio libpal liblog "
