...
def setup_board_routes(app):
    ...
    app.router.add_get(board_routes[18], bhandler.rest_sensors_pem1_hdl)
    app.router.add_get(board_routes[19], bhandler.rest_sensors_pem2_hdl)
    app.router.add_get(board_routes[20], bhandler.rest_sensors_psu1_hdl)
