...
struct vr_info cxl_vr_list[] = {
  [JCN1_VR_CXL_A0V8_9] = {
    ...
    .dev_name = "MEB CXL8 VR_P0V89A",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl8",
    .xfer = cxl_vr_pldm_wr,
  },
  [JCN1_VR_CXL_VDDQ_AB] = {
    .bus = CXL_VR_BUS_ID,
    .addr = AADR_CXL_VR_VDDQ_AB,
    .dev_name = "MEB CXL8 VR_P0V8D_PVDDQ_AB",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl8",
    .xfer = cxl_vr_pldm_wr,
  },
  ...
  [JCN2_VR_CXL_A0V8_9] = {
    .bus = CXL_VR_BUS_ID,
    .addr = ADDR_CXL_VR_A0V8_9,
    .dev_name = "MEB CXL7 VR_P0V89A",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl7",
    .xfer = cxl_vr_pldm_wr,
  },
  [JCN2_VR_CXL_VDDQ_AB] = {
    .bus = CXL_VR_BUS_ID,
    .addr = AADR_CXL_VR_VDDQ_AB,
    .dev_name = "MEB CXL7 VR_P0V8D_PVDDQ_AB",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl7",
    .xfer = cxl_vr_pldm_wr,
  },
  ...
  [JCN3_VR_CXL_A0V8_9] = {
    .bus = CXL_VR_BUS_ID,
    .addr = ADDR_CXL_VR_A0V8_9,
    .dev_name = "MEB CXL6 VR_P0V89A",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl6",
    .xfer = cxl_vr_pldm_wr,
  },
  [JCN3_VR_CXL_VDDQ_AB] = {
    .bus = CXL_VR_BUS_ID,
    .addr = AADR_CXL_VR_VDDQ_AB,
    .dev_name = "MEB CXL6 VR_P0V8D_PVDDQ_AB",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl6",
    .xfer = cxl_vr_pldm_wr,
  },
  ...
  [JCN4_VR_CXL_A0V8_9] = {
    .bus = CXL_VR_BUS_ID,
    .addr = ADDR_CXL_VR_A0V8_9,
    .dev_name = "MEB CXL5 VR_P0V89A",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl5",
    .xfer = cxl_vr_pldm_wr,
  },
  [JCN4_VR_CXL_VDDQ_AB] = {
    .bus = CXL_VR_BUS_ID,
    .addr = AADR_CXL_VR_VDDQ_AB,
    .dev_name = "MEB CXL5 VR_P0V8D_PVDDQ_AB",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl5",
    .xfer = cxl_vr_pldm_wr,
  },
  ...
  [JCN9_VR_CXL_A0V8_9] = {
    .bus = CXL_VR_BUS_ID,
    .addr = ADDR_CXL_VR_A0V8_9,
    .dev_name = "MEB CXL3 VR_P0V89A",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl3",
    .xfer = cxl_vr_pldm_wr,
  },
  [JCN9_VR_CXL_VDDQ_AB] = {
    .bus = CXL_VR_BUS_ID,
    .addr = AADR_CXL_VR_VDDQ_AB,
    .dev_name = "MEB CXL3 VR_P0V8D_PVDDQ_AB",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl3",
    .xfer = cxl_vr_pldm_wr,
  },
  ...
  [JCN10_VR_CXL_A0V8_9] = {
    .bus = CXL_VR_BUS_ID,
    .addr = ADDR_CXL_VR_A0V8_9,
    .dev_name = "MEB CXL4 VR_P0V89A",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl4",
    .xfer = cxl_vr_pldm_wr,
  },
  [JCN10_VR_CXL_VDDQ_AB] = {
    .bus = CXL_VR_BUS_ID,
    .addr = AADR_CXL_VR_VDDQ_AB,
    .dev_name = "MEB CXL4 VR_P0V8D_PVDDQ_AB",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl4",
    .xfer = cxl_vr_pldm_wr,
  },
  ...
  [JCN11_VR_CXL_A0V8_9] = {
    .bus = CXL_VR_BUS_ID,
    .addr = ADDR_CXL_VR_A0V8_9,
    .dev_name = "MEB CXL1 VR_P0V89A",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl1",
    .xfer = cxl_vr_pldm_wr,
  },
  [JCN11_VR_CXL_VDDQ_AB] = {
    .bus = CXL_VR_BUS_ID,
    .addr = AADR_CXL_VR_VDDQ_AB,
    .dev_name = "MEB CXL1 VR_P0V8D_PVDDQ_AB",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl1",
    .xfer = cxl_vr_pldm_wr,
  },
  ...
  [JCN12_VR_CXL_A0V8_9] = {
    .bus = CXL_VR_BUS_ID,
    .addr = ADDR_CXL_VR_A0V8_9,
    .dev_name = "MEB CXL2 VR_P0V89A",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl2",
    .xfer = cxl_vr_pldm_wr,
  },
  [JCN12_VR_CXL_VDDQ_AB] = {
    .bus = CXL_VR_BUS_ID,
    .addr = AADR_CXL_VR_VDDQ_AB,
    .dev_name = "MEB CXL2 VR_P0V8D_PVDDQ_AB",
    .ops = &xdpe12284c_ops,
    .private_data = "meb_cxl2",
    .xfer = cxl_vr_pldm_wr,
  },
