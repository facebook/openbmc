...
from common.base_bmc_scripts_sysfs_dependency_test import BaseBmcShellScriptsSysfsDependencyTest
...
class BmcShellScriptsSysfsDependencyTest(BaseBmcShellScriptsSysfsDependencyTest):
    ...
    def test_cp2112_i2c_flush_sysfs_dependency(self):
        set = [
            "/sys/bus/i2c/devices/i2c-12/12-0031/i2c_flush_en"
        ]
        self.verify_if_path_exists(set)
    ...
    def test_reset_cp2112_sysfs_dependency(self):
        set =  [
            "/sys/bus/i2c/devices/i2c-12/12-0031/usb2cp2112_rst_n"
        ]
        self.verify_if_path_exists(set)
    ...
    def test_setup_board_sysfs_dependency(self):
        set =  [
            "/sys/bus/i2c/devices/i2c-12/12-0031/com-e_i2c_isobuf_en"
        ]
        self.verify_if_path_exists(set)
