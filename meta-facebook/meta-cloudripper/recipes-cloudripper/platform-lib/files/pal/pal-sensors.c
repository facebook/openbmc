...
static int get_smb_sensor_name(uint8_t sensor_num, char *name) {
  ...
  switch (sensor_num) {
    ...
    case SMB_BMC_ADC2_VSEN:
      ...
      break;
    case SMB_BMC_ADC3_VSEN:
      sprintf(name, "SMB_SMB_XP3R3V_RIGHT");
      break;
    case SMB_BMC_ADC4_VSEN:
...
static void sensor_thresh_array_init(uint8_t fru) {
  ...
  switch (fru) {
    ...
    case FRU_SMB:
      ...
      smb_sensor_threshold[SMB_SENSOR_1220_VMON2][UCR_THRESH] = 5.3;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON2][LCR_THRESH] = 4.8;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON3][UCR_THRESH] = 3.4;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON3][LCR_THRESH] = 3.2;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON4][UCR_THRESH] = 3.4;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON4][LCR_THRESH] = 3.2;
      ...
      smb_sensor_threshold[SMB_SENSOR_1220_VMON7][UCR_THRESH] = 1.85;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON7][LCR_THRESH] = 1.75;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON8][UCR_THRESH] = 2.58;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON8][LCR_THRESH] = 2.43;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON9][UCR_THRESH] = 0.97;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON9][LCR_THRESH] = 0.91;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON10][UCR_THRESH] = 0.87;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON10][LCR_THRESH] = 0.78;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON11][UCR_THRESH] = 0.77;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON11][LCR_THRESH] = 0.73;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON12][UCR_THRESH] = 1.18;
      smb_sensor_threshold[SMB_SENSOR_1220_VMON12][LCR_THRESH] = 1.12;
      smb_sensor_threshold[SMB_SENSOR_1220_VCCA][UCR_THRESH] = 3.4;
      smb_sensor_threshold[SMB_SENSOR_1220_VCCA][LCR_THRESH] = 3.2;
      smb_sensor_threshold[SMB_SENSOR_1220_VCCINP][UCR_THRESH] = 3.4;
      smb_sensor_threshold[SMB_SENSOR_1220_VCCINP][LCR_THRESH] = 3.2;

      /* BMC ADC Sensors */
      smb_sensor_threshold[SMB_BMC_ADC0_VSEN][UCR_THRESH] = 1.05;
      smb_sensor_threshold[SMB_BMC_ADC0_VSEN][LCR_THRESH] = 0.95;
      smb_sensor_threshold[SMB_BMC_ADC1_VSEN][UCR_THRESH] = 1.23;
      smb_sensor_threshold[SMB_BMC_ADC1_VSEN][LCR_THRESH] = 1.17;
      smb_sensor_threshold[SMB_BMC_ADC2_VSEN][UCR_THRESH] = 3.4;
      smb_sensor_threshold[SMB_BMC_ADC2_VSEN][LCR_THRESH] = 3.2;
      smb_sensor_threshold[SMB_BMC_ADC3_VSEN][UCR_THRESH] = 3.4;
      smb_sensor_threshold[SMB_BMC_ADC3_VSEN][LCR_THRESH] = 3.2;
      smb_sensor_threshold[SMB_BMC_ADC4_VSEN][UCR_THRESH] = 0.93;
      smb_sensor_threshold[SMB_BMC_ADC4_VSEN][LCR_THRESH] = 0.87;
      smb_sensor_threshold[SMB_BMC_ADC5_VSEN][UCR_THRESH] = 1.9;
      smb_sensor_threshold[SMB_BMC_ADC5_VSEN][LCR_THRESH] = 1.8;
      smb_sensor_threshold[SMB_BMC_ADC6_VSEN][UCR_THRESH] = 0.93;
      smb_sensor_threshold[SMB_BMC_ADC6_VSEN][LCR_THRESH] = 0.87;
      smb_sensor_threshold[SMB_BMC_ADC7_VSEN][UCR_THRESH] = 1.9;
      smb_sensor_threshold[SMB_BMC_ADC7_VSEN][LCR_THRESH] = 1.8;
      smb_sensor_threshold[SMB_BMC_ADC8_VSEN][UCR_THRESH] = 1.89;
      smb_sensor_threshold[SMB_BMC_ADC8_VSEN][LCR_THRESH] = 1.71;
      smb_sensor_threshold[SMB_BMC_ADC9_VSEN][UCR_THRESH] = 0.79;
      smb_sensor_threshold[SMB_BMC_ADC9_VSEN][LCR_THRESH] = 0.71;
      smb_sensor_threshold[SMB_BMC_ADC10_VSEN][UCR_THRESH] = 1.26;
      smb_sensor_threshold[SMB_BMC_ADC10_VSEN][LCR_THRESH] = 1.14;
      smb_sensor_threshold[SMB_BMC_ADC11_VSEN][UCR_THRESH] = 2.57;
      smb_sensor_threshold[SMB_BMC_ADC11_VSEN][LCR_THRESH] = 2.43;

      smb_sensor_threshold[SMB_SENSOR_VDDA_IN_VOLT][UCR_THRESH] = 12.6;
      smb_sensor_threshold[SMB_SENSOR_VDDA_IN_VOLT][LCR_THRESH] = 11.4;
      smb_sensor_threshold[SMB_SENSOR_VDDA_IN_CURR][UCR_THRESH] = 7.5;
      smb_sensor_threshold[SMB_SENSOR_VDDA_IN_POWER][UCR_THRESH] = 94;
      ...
      smb_sensor_threshold[SMB_SENSOR_VDDA_OUT_CURR][UCR_THRESH] = 80;
      smb_sensor_threshold[SMB_SENSOR_VDDA_OUT_POWER][UCR_THRESH] = 75.2;
      ...
      smb_sensor_threshold[SMB_SENSOR_PCIE_IN_CURR][UCR_THRESH] = 6.1;
      smb_sensor_threshold[SMB_SENSOR_PCIE_IN_POWER][UCR_THRESH] = 77;
      smb_sensor_threshold[SMB_SENSOR_PCIE_OUT_VOLT][UCR_THRESH] = 0.77;
      smb_sensor_threshold[SMB_SENSOR_PCIE_OUT_VOLT][LCR_THRESH] = 0.73;
      smb_sensor_threshold[SMB_SENSOR_PCIE_OUT_CURR][UCR_THRESH] = 80;
      smb_sensor_threshold[SMB_SENSOR_PCIE_OUT_POWER][UCR_THRESH] = 61.6;
      ...
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_LEFT_IN_CURR][UCR_THRESH] = 42.5;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_LEFT_IN_POWER][UCR_THRESH] = 510;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_LEFT_OUT_VOLT][UCR_THRESH] = 3.4;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_LEFT_OUT_VOLT][LCR_THRESH] = 3.2;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_LEFT_OUT_CURR][UCR_THRESH] = 120;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_LEFT_OUT_POWER][UCR_THRESH] = 408;
      ...
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_RIGHT_IN_CURR][UCR_THRESH] = 42.5;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_RIGHT_IN_POWER][UCR_THRESH] = 510;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_RIGHT_OUT_VOLT][UCR_THRESH] = 3.4;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_RIGHT_OUT_VOLT][LCR_THRESH] = 3.2;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_RIGHT_OUT_CURR][UCR_THRESH] = 120;
      smb_sensor_threshold[SMB_SENSOR_IR3R3V_RIGHT_OUT_POWER][UCR_THRESH] = 408;
      ...
      smb_sensor_threshold[SMB_SENSOR_SW_CORE_IN_CURR][UCR_THRESH] = 37;
      smb_sensor_threshold[SMB_SENSOR_SW_CORE_IN_POWER][UCR_THRESH] = 466.9;
      smb_sensor_threshold[SMB_SENSOR_SW_CORE_TEMP1][UCR_THRESH] = 85;
      smb_sensor_threshold[SMB_SENSOR_SW_CORE_OUT_VOLT][UCR_THRESH] = 0.87;
      smb_sensor_threshold[SMB_SENSOR_SW_CORE_OUT_VOLT][LCR_THRESH] = 0.78;
      smb_sensor_threshold[SMB_SENSOR_SW_CORE_OUT_CURR][UCR_THRESH] = 450;
      smb_sensor_threshold[SMB_SENSOR_SW_CORE_OUT_POWER][UCR_THRESH] = 373.5;
      ...
      smb_sensor_threshold[SMB_SENSOR_XPDE_HBM_IN_CURR][UCR_THRESH] = 6.1;
      smb_sensor_threshold[SMB_SENSOR_XPDE_HBM_IN_POWER][UCR_THRESH] = 76.9;
      smb_sensor_threshold[SMB_SENSOR_XPDE_HBM_TEMP1][UCR_THRESH] = 85;
      smb_sensor_threshold[SMB_SENSOR_XPDE_HBM_OUT_VOLT][UCR_THRESH] = 1.23;
      smb_sensor_threshold[SMB_SENSOR_XPDE_HBM_OUT_VOLT][LCR_THRESH] = 1.17;
      smb_sensor_threshold[SMB_SENSOR_XPDE_HBM_OUT_CURR][UCR_THRESH] = 50;
      smb_sensor_threshold[SMB_SENSOR_XPDE_HBM_OUT_POWER][UCR_THRESH] = 61.5;
      ...
      smb_sensor_threshold[SMB_SENSOR_VDDCK_0_IN_CURR][UCR_THRESH] = 1.4;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_0_IN_POWER][UCR_THRESH] = 17.7;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_0_OUT_VOLT][UCR_THRESH] = 1.18;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_0_OUT_VOLT][LCR_THRESH] = 1.12;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_0_OUT_CURR][UCR_THRESH] = 12;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_0_OUT_POWER][UCR_THRESH] = 14.16;
      ...
      smb_sensor_threshold[SMB_SENSOR_VDDCK_1_IN_CURR][UCR_THRESH] = 1.4;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_1_IN_POWER][UCR_THRESH] = 17.7;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_1_OUT_VOLT][UCR_THRESH] = 1.18;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_1_OUT_VOLT][LCR_THRESH] = 1.12;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_1_OUT_CURR][UCR_THRESH] = 12;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_1_OUT_POWER][UCR_THRESH] = 14.16;
      ...
      smb_sensor_threshold[SMB_SENSOR_VDDCK_2_IN_CURR][UCR_THRESH] = 1.4;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_2_IN_POWER][UCR_THRESH] = 17.7;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_2_OUT_VOLT][UCR_THRESH] = 1.18;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_2_OUT_VOLT][LCR_THRESH] = 1.12;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_2_OUT_CURR][UCR_THRESH] = 12;
      smb_sensor_threshold[SMB_SENSOR_VDDCK_2_OUT_POWER][UCR_THRESH] = 14.16;
      ...
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_1_IN_CURR][UCR_THRESH] = 27.68;
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_1_IN_POWER][UCR_THRESH] = 348.75;
      ...
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_1_OUT_CURR][UCR_THRESH] = 300;
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_1_OUT_POWER][UCR_THRESH] = 279;
      ...
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_2_IN_CURR][UCR_THRESH] = 15.07;
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_2_IN_POWER][UCR_THRESH] = 190;
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_2_OUT_VOLT][UCR_THRESH] = 1.9;
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_2_OUT_VOLT][LCR_THRESH] = 1.8;
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_2_OUT_CURR][UCR_THRESH] = 80;
      smb_sensor_threshold[SMB_SENSOR_XDPE_LEFT_2_OUT_POWER][UCR_THRESH] = 152;
      ...
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_1_IN_CURR][UCR_THRESH] = 27.68;
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_1_IN_POWER][UCR_THRESH] = 348.75;
      ...
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_1_OUT_CURR][UCR_THRESH] = 300;
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_1_OUT_POWER][UCR_THRESH] = 279;
      ...
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_2_IN_CURR][UCR_THRESH] = 15.07;
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_2_IN_POWER][UCR_THRESH] = 190;
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_2_OUT_VOLT][UCR_THRESH] = 1.9;
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_2_OUT_VOLT][LCR_THRESH] = 1.8;
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_2_OUT_CURR][UCR_THRESH] = 80;
      smb_sensor_threshold[SMB_SENSOR_XDPE_RIGHT_2_OUT_POWER][UCR_THRESH] = 152;
