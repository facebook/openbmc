...
class FruSlot1Test(CommonFruTest, unittest.TestCase):
    def setUp(self):
        ...
        self.fru_fields = {"product": 2, "board": 1}
...
class FruNicTest(CommonFruTest, unittest.TestCase):
    def setUp(self):
        ...
        self.fru_fields = {"product": 3, "board": 1}
