...
class FwUpgradeTest(unittest.TestCase):
    ...
    _COMPONENTS = {
        "bic": [
            1,
            "/usr/bin/fw-util server --update bic {filename}",
        ],
        "bios": [
            2,
            "/usr/bin/fw-util server --update bios {filename}",
        ],
        "server_fpga": [
            3,
            "/usr/bin/fw-util server --update fpga {filename}",
        ],
        "uic_fpga": [
            4,
            "/usr/bin/fw-util uic --update fpga {filename}",
        ],
        "bmc": [
            5,
            "/usr/bin/fw-util bmc --update bmc {filename}",
        ],
        "rom": [
            6,
            "/usr/bin/fw-util bmc --update rom {filename}",
        ],
    }
