...
#define SIZE_CPU_POWER_LIMIT_DATA 1
...
enum
{
  ...
  CMD_OEM_SET_POWER_LIMIT = 0x60,
  CMD_OEM_GET_POWER_LIMIT = 0x61,
  ...
  CMD_OEM_GET_POWER_READING = 0xE2,
  ...
  CMD_OEM_GET_HTTPS_BOOT_CERT_DATA = 0x57,
  CMD_OEM_GET_HTTPS_BOOT_CERT_ATTR = 0x58,
};
...
enum
{
  ...
  CMD_OEM_1S_GET_SET_VIRTUAL_GPIO = 0x42,
  CMD_OEM_1S_GET_SHA256 = 0x43,
  CMD_OEM_1S_UPDATE_SDR = 0x44,
  CMD_OEM_1S_SET_DELAY_ACTIVATE_SYSFW = 0x45,
