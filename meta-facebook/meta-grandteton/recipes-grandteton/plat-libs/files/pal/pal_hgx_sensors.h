...
enum {
  ...
  // Retimer VR
  GPU_RETIMER_0_1_0V9_VR_TEMP = 0x7A,
  GPU_RETIMER_2_3_0V9_VR_TEMP = 0x7B,
  GPU_RETIMER_4_5_0V9_VR_TEMP = 0x7C,
  GPU_RETIMER_6_7_0V9_VR_TEMP = 0x7D,
  GPU_RETIMER_0_1_2_3_1V2_VR_TEMP = 0x7E,
  GPU_RETIMER_4_5_6_7_1V2_VR_TEMP = 0x7F,

  // UBB
  UBB_WARMEST_HSC_TEMP = 0x80,
  UBB_FPGA_0V72_VR_TEMP = 0x81,
  UBB_FPGA_3V3_VR_TEMP = 0x82,
  UBB_0_1_2_3_3V3_VR_TEMP = 0x83,
  UBB_4_5_6_7_3V3_VR_TEMP = 0x84,
  UBB_IBC_HSC_TEMP = 0x85,
