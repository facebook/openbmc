...
static const i2c_dev_attr_st smb_syscpld_attr_table[] = {
  ...
  {
    "temp_sensor_cpld_alert_1_status",
    intr_help_str,
    I2C_DEV_ATTR_SHOW_DEFAULT,
    NULL,
    0x30, 0, 1,
  ...
  {
    "temp_sensor_cpld_alert_2_status",
    intr_help_str,
    I2C_DEV_ATTR_SHOW_DEFAULT,
    NULL,
    0x30, 1, 1,
  ...
  {
    "temp_sensor_cpld_alert_3_status",
    intr_help_str,
    I2C_DEV_ATTR_SHOW_DEFAULT,
    NULL,
    0x30, 2, 1,
  ...
  {
    "temp_sensor_cpld_alert_4_status",
    intr_help_str,
    I2C_DEV_ATTR_SHOW_DEFAULT,
    NULL,
    0x30, 3, 1,
