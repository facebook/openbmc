...
enum {
  ...
  GPV2_SENSOR_DEV0_FPGA_PW = 0x32,
  GPV2_SENSOR_DEV0_FPGA_VOL = 0x33,
  GPV2_SENSOR_DEV0_DDR_PW = 0x34,
  GPV2_SENSOR_DEV0_DDR_VOL = 0x35,
  GPV2_SENSOR_DEV0_Temp = 0x36,
  //M.2 1
  GPV2_SENSOR_DEV1_INA231_PW = 0x40,
  GPV2_SENSOR_DEV1_INA231_VOL = 0x41,
  GPV2_SENSOR_DEV1_FPGA_PW = 0x42,
  GPV2_SENSOR_DEV1_FPGA_VOL = 0x43,
  GPV2_SENSOR_DEV1_DDR_PW = 0x44,
  GPV2_SENSOR_DEV1_DDR_VOL = 0x45,
  GPV2_SENSOR_DEV1_Temp = 0x46,
  //M.2 2
  GPV2_SENSOR_DEV2_INA231_PW = 0x50,
  GPV2_SENSOR_DEV2_INA231_VOL = 0x51,
  GPV2_SENSOR_DEV2_FPGA_PW = 0x52,
  GPV2_SENSOR_DEV2_FPGA_VOL = 0x53,
  GPV2_SENSOR_DEV2_DDR_PW = 0x54,
  GPV2_SENSOR_DEV2_DDR_VOL = 0x55,
  GPV2_SENSOR_DEV2_Temp = 0x56,
  //M.2 3
  GPV2_SENSOR_DEV3_INA231_PW = 0x60,
  GPV2_SENSOR_DEV3_INA231_VOL = 0x61,
  GPV2_SENSOR_DEV3_FPGA_PW = 0x62,
  GPV2_SENSOR_DEV3_FPGA_VOL = 0x63,
  GPV2_SENSOR_DEV3_DDR_PW = 0x64,
  GPV2_SENSOR_DEV3_DDR_VOL = 0x65,
  GPV2_SENSOR_DEV3_Temp = 0x66,
  //M.2 4
  GPV2_SENSOR_DEV4_INA231_PW = 0x70,
  GPV2_SENSOR_DEV4_INA231_VOL = 0x71,
  GPV2_SENSOR_DEV4_FPGA_PW = 0x72,
  GPV2_SENSOR_DEV4_FPGA_VOL = 0x73,
  GPV2_SENSOR_DEV4_DDR_PW = 0x74,
  GPV2_SENSOR_DEV4_DDR_VOL = 0x75,
  GPV2_SENSOR_DEV4_Temp = 0x76,
  //M.2 5
  GPV2_SENSOR_DEV5_INA231_PW = 0x80,
  GPV2_SENSOR_DEV5_INA231_VOL = 0x81,
  GPV2_SENSOR_DEV5_FPGA_PW = 0x82,
  GPV2_SENSOR_DEV5_FPGA_VOL = 0x83,
  GPV2_SENSOR_DEV5_DDR_PW = 0x84,
  GPV2_SENSOR_DEV5_DDR_VOL = 0x85,
  GPV2_SENSOR_DEV5_Temp = 0x86,
  //M.2 6
  GPV2_SENSOR_DEV6_INA231_PW = 0x90,
  GPV2_SENSOR_DEV6_INA231_VOL = 0x91,
  GPV2_SENSOR_DEV6_FPGA_PW = 0x92,
  GPV2_SENSOR_DEV6_FPGA_VOL = 0x93,
  GPV2_SENSOR_DEV6_DDR_PW = 0x94,
  GPV2_SENSOR_DEV6_DDR_VOL = 0x95,
  GPV2_SENSOR_DEV6_Temp = 0x96,
  //M.2 7
  GPV2_SENSOR_DEV7_INA231_PW = 0xA0,
  GPV2_SENSOR_DEV7_INA231_VOL = 0xA1,
  GPV2_SENSOR_DEV7_FPGA_PW = 0xA2,
  GPV2_SENSOR_DEV7_FPGA_VOL = 0xA3,
  GPV2_SENSOR_DEV7_DDR_PW = 0xA4,
  GPV2_SENSOR_DEV7_DDR_VOL = 0xA5,
  GPV2_SENSOR_DEV7_Temp = 0xA6,
  //M.2 8
  GPV2_SENSOR_DEV8_INA231_PW = 0xB0,
  GPV2_SENSOR_DEV8_INA231_VOL = 0xB1,
  GPV2_SENSOR_DEV8_FPGA_PW = 0xB2,
  GPV2_SENSOR_DEV8_FPGA_VOL = 0xB3,
  GPV2_SENSOR_DEV8_DDR_PW = 0xB4,
  GPV2_SENSOR_DEV8_DDR_VOL = 0xB5,
  GPV2_SENSOR_DEV8_Temp = 0xB6,
  //M.2 9
  GPV2_SENSOR_DEV9_INA231_PW = 0xC0,
  GPV2_SENSOR_DEV9_INA231_VOL = 0xC1,
  GPV2_SENSOR_DEV9_FPGA_PW = 0xC2,
  GPV2_SENSOR_DEV9_FPGA_VOL = 0xC3,
  GPV2_SENSOR_DEV9_DDR_PW = 0xC4,
  GPV2_SENSOR_DEV9_DDR_VOL = 0xC5,
  GPV2_SENSOR_DEV9_Temp = 0xC6,
  //M.2 10
  GPV2_SENSOR_DEV10_INA231_PW = 0xE0,
  GPV2_SENSOR_DEV10_INA231_VOL = 0xE1,
  GPV2_SENSOR_DEV10_FPGA_PW = 0xE2,
  GPV2_SENSOR_DEV10_FPGA_VOL = 0xE3,
  GPV2_SENSOR_DEV10_DDR_PW = 0xE4,
  GPV2_SENSOR_DEV10_DDR_VOL = 0xE5,
  GPV2_SENSOR_DEV10_Temp = 0xE6,
  //M.2 11
  GPV2_SENSOR_DEV11_INA231_PW = 0xF0,
  GPV2_SENSOR_DEV11_INA231_VOL = 0xF1,
  GPV2_SENSOR_DEV11_FPGA_PW = 0xF2,
  GPV2_SENSOR_DEV11_FPGA_VOL = 0xF3,
  GPV2_SENSOR_DEV11_DDR_PW = 0xF4,
  GPV2_SENSOR_DEV11_DDR_VOL = 0xF5,
