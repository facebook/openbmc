...
# Swap FCM,SYS JTAG Enable in Wedge400 EVT-MP - Respin
    BoardGPIO("GPIOJ0", "PWR_CPLD_JTAG_EN_N"),
    BoardGPIO("GPIOJ1", "FCM_CPLD_JTAG_EN_N"),
    BoardGPIO("GPIOJ2", "SYS_CPLD_JTAG_EN_N"),
    BoardGPIO("GPIOJ3", "SCM_CPLD_JTAG_EN_N"),
...
board_gpio_table_v1_gb = [
    ...
    BoardGPIO("GPIOI6", "BMC_SPI1_MOSI"),
    BoardGPIO("GPIOI7", "BMC_SPI1_MISO"),
# Swap FCM,SYS JTAG Enable in Wedge400C EVT-DVT
    BoardGPIO("GPIOJ0", "PWR_CPLD_JTAG_EN_N"),
    BoardGPIO("GPIOJ1", "FCM_CPLD_JTAG_EN_N"),
    BoardGPIO("GPIOJ2", "SYS_CPLD_JTAG_EN_N"),
    BoardGPIO("GPIOJ3", "SCM_CPLD_JTAG_EN_N"),
...
board_gpio_table_v1_gb_respin = [
    ...
    BoardGPIO("GPIOJ2", "FCM_CPLD_JTAG_EN_N"),
    BoardGPIO("GPIOJ3", "SCM_CPLD_JTAG_EN_N"),
    BoardGPIO("GPIOM0", "BMC_CPLD_SPARE1"),
    BoardGPIO("GPIOM1", "BMC_CPLD_SPARE2"),
    BoardGPIO("GPIOM2", "BMC_CPLD_SPARE3"),
