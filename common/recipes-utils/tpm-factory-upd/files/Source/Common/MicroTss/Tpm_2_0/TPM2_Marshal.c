	...
	_Inout_	TSS_INT32*		PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_UINT8));
	...
	_In_	TSS_INT32		PnCount)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_BYTE));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*		PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_UINT16));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*		PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_UINT32));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_In_	TSS_INT32					PnCount)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPM_ECC_CURVE));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_In_	TSS_INT32			PnCount)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPM_CC));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_In_	TSS_INT32			PnCount)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPM_HANDLE));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_In_	TSS_INT32			PnCount)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPMA_CC));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*					PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPM2B_DIGEST));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*						PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPM2B_MAX_BUFFER));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*					PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPM2B_TIMEOUT));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*						PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPMS_PCR_SELECTION));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*					PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPMT_TK_AUTH));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*						PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPMS_ALG_PROPERTY));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*							PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPMS_TAGGED_PROPERTY));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*							PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPMS_TAGGED_PCR_SELECT));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*			PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPML_CC));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*				PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPML_CCA));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*				PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPML_HANDLE));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*						PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPML_PCR_SELECTION));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*						PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPML_ALG_PROPERTY));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*								PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPML_TAGGED_TPM_PROPERTY));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*								PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPML_TAGGED_PCR_PROPERTY));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*					PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPML_ECC_CURVE));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*							PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_TPMS_CAPABILITY_DATA));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
	...
	_Inout_	TSS_INT32*								PpnSize)
{
	...
	do
	{
		...
		unReturnValue = Platform_MemorySet(PpTarget, 0x00, sizeof(TSS_AcknowledgmentResponseData));
		if (RC_SUCCESS != unReturnValue)
			break;
		// Check _Inout_ parameters
		if ((NULL == PprgbBuffer) || (NULL == *PprgbBuffer) || (NULL == PpnSize))
