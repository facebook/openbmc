...
class commonApp_Handler:
    ...
    @staticmethod
    async def rest_modbus_reload_post(request: web.Request) -> web.Response:
        return await rest_modbus.post_modbus_reload(request)

    @staticmethod
    async def rest_modbus_devices_get(request: web.Request) -> web.Response:
        return await rest_modbus.get_modbus_devices()

    @staticmethod
    async def rest_modbus_read_post(request: web.Request) -> web.Response:
        return await rest_modbus_cmd.post_modbus_read(request)
    ...
    @staticmethod
    async def rest_modbus_control(request: web.Request) -> web.Response:
        return await rest_modbus_cmd.post_modbus_control(request)
