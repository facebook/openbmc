...
FW_TOOLS = "\
    ...
    sd-bic,chassis-poweron@%i.service_chassis-powercycle@%i.service,obmc-chassis-powercycle@%i.target,obmc-chassis-poweron@%i.target_obmc-chassis-powercycle@%i.target,${HOST_INSTANCES} \
    sd-cpld,chassis-poweron@%i.service_chassis-powercycle@%i.service,obmc-chassis-powercycle@%i.target,obmc-chassis-poweron@%i.target_obmc-chassis-powercycle@%i.target,${HOST_INSTANCES} \
    ...
    sd-vr,chassis-poweron@%i.service_chassis-powercycle@%i.service,obmc-chassis-powercycle@%i.target,obmc-chassis-poweron@%i.target_obmc-chassis-powercycle@%i.target,${HOST_INSTANCES} \
    ...
    wf-bic,chassis-poweron@%i.service_chassis-powercycle@%i.service,obmc-chassis-powercycle@%i.target,obmc-chassis-poweron@%i.target_obmc-chassis-powercycle@%i.target,${HOST_INSTANCES} \
