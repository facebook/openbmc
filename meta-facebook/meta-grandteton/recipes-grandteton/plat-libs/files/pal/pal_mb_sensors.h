...
//MB TEMP
  MB_SNR_OUTLET_TEMP_L = 0x10,
  MB_SNR_INLET_TEMP_L = 0x11,
  MB_SNR_OUTLET_TEMP_R = 0x12,
  MB_SNR_INLET_TEMP_R = 0x13,
...
//MB Discrete SNR
  ...
  MB_SNR_RETIMER0_HEALTHY = 0xA8,
  MB_SNR_RETIMER1_HEALTHY = 0xA9,
  MB_SNR_RETIMER2_HEALTHY = 0xAA,
  MB_SNR_RETIMER3_HEALTHY = 0xAB,
  MB_SNR_RETIMER4_HEALTHY = 0xAC,
  MB_SNR_RETIMER5_HEALTHY = 0xAD,
  MB_SNR_RETIMER6_HEALTHY = 0xAE,
  MB_SNR_RETIMER7_HEALTHY = 0xAF,
...
//MB DIMM STATE
  ...
  MB_SNR_RETIMER2_TEMP = 0xD2,
  MB_SNR_RETIMER3_TEMP = 0xD3,
  MB_SNR_RETIMER4_TEMP = 0xD4,
  MB_SNR_RETIMER5_TEMP = 0xD5,
  MB_SNR_RETIMER6_TEMP = 0xD6,
  MB_SNR_RETIMER7_TEMP = 0xD7,
  MB_SNR_P5V_AUX_ADC         = 0xD8,
  MB_SNR_P1V8_AUX_ADC        = 0xD9,
  MB_SNR_P1V2_AUX_ADC        = 0xDA,
  MB_SNR_P1V8_CPU0_RT_1D_ADC = 0xDB,
  MB_SNR_P1V8_CPU1_RT_1D_ADC = 0xDC,
  MB_SNR_PVDD_33_S5_ADC      = 0xDD,
  MB_SNR_PVDD18_S5_P0_ADC    = 0xDE,
  MB_SNR_PVDD18_S5_P1_ADC    = 0xDF,

  MB_SNR_VR_RT_P0V9_VDD1_TEMP = 0xE0,
  MB_SNR_VR_RT_P0V9_VDD1_VOUT = 0xE1,
  MB_SNR_VR_RT_P0V9_VDD1_IOUT = 0xE2,
  MB_SNR_VR_RT_P0V9_VDD1_POUT = 0xE3,
  MB_SNR_VR_RT_P0V9_VDD2_TEMP = 0xE4,
  MB_SNR_VR_RT_P0V9_VDD2_VOUT = 0xE5,
  MB_SNR_VR_RT_P0V9_VDD2_IOUT = 0xE6,
  MB_SNR_VR_RT_P0V9_VDD2_POUT = 0xE7,
};
