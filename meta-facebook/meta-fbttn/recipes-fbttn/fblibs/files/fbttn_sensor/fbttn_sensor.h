...
enum{
  ...
  DPB_SENSOR_FAN0_REAR = 0x6A,
  DPB_SENSOR_FAN1_FRONT = 0x6B,
  DPB_SENSOR_FAN1_REAR = 0x6C,
  DPB_SENSOR_FAN2_FRONT = 0x6D,
  DPB_SENSOR_FAN2_REAR = 0x6E,
  DPB_SENSOR_FAN3_FRONT = 0x6F,
