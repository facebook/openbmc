...
static sensor_desc_c cri_sensor[]  =
{
    ...
    {"DIMMA012_TEMP:"   , MB_SENSOR_CPU0_DIMM_GRPA_TEMP,"C"},
    {"DIMMA345_TEMP:"   , MB_SENSOR_CPU0_DIMM_GRPB_TEMP,"C"},
    {"DIMMB012_TEMP:"   , MB_SENSOR_CPU1_DIMM_GRPC_TEMP,"C"},
    {"DIMMB345_TEMP:"   , MB_SENSOR_CPU1_DIMM_GRPD_TEMP,"C"},
    {"LAST_KEY",' ' ," " },
};
