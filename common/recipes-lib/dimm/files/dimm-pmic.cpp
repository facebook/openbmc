...
static const pmic_err_info pmic_err[MAX_PMIC_ERR_TYPE] = {
  ...
  {{0x02, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00}, true,  STR_SWA_OV,     {TYPE_UNDEF, VOLT_OV, RAIL_SWA_OUT, ERR_INJ_ENABLE}},
  {{0x02, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00}, true,  STR_SWB_OV,     {TYPE_UNDEF, VOLT_OV, RAIL_SWB_OUT, ERR_INJ_ENABLE}},
  {{0x02, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00}, true,  STR_SWC_OV,     {TYPE_UNDEF, VOLT_OV, RAIL_SWC_OUT, ERR_INJ_ENABLE}},
  {{0x02, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00}, true,  STR_SWD_OV,     {TYPE_UNDEF, VOLT_OV, RAIL_SWD_OUT, ERR_INJ_ENABLE}},
  ...
  {{0x02, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00}, true,  STR_SWA_UV,     {TYPE_UNDEF, VOLT_UV, RAIL_SWA_OUT, ERR_INJ_ENABLE}},
  {{0x02, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00}, true,  STR_SWB_UV,     {TYPE_UNDEF, VOLT_UV, RAIL_SWB_OUT, ERR_INJ_ENABLE}},
  {{0x02, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00}, true,  STR_SWC_UV,     {TYPE_UNDEF, VOLT_UV, RAIL_SWC_OUT, ERR_INJ_ENABLE}},
  {{0x02, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00}, true,  STR_SWD_UV,     {TYPE_UNDEF, VOLT_UV, RAIL_SWD_OUT, ERR_INJ_ENABLE}},
  {{0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00}, true,  STR_BULK_UV,    {TYPE_UNDEF, VOLT_UV, RAIL_VIN_BULK, ERR_INJ_ENABLE}},
