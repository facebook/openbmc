...
DEPENDS += "libbic libexp libmctp libfbttn-common libfbttn-fruid libfbttn-sensor libkv libedb"
...
RDEPENDS_${PN} += " libfbttn-common libkv"
RDEPENDS_${PN} += " libfbttn-common libedb"
