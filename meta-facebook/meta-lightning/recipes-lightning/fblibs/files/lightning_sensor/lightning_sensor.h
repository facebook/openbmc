...
enum {
  ...
  //PEB_SENSOR_SW_TEMP_1 = 0x53,
  //PEB_SENSOR_SW_TEMP_2 = 0x54,
  PEB_SENSOR_TEMP_1 = 0x55,
  PEB_SENSOR_TEMP_2 = 0x56,
  PEB_SENSOR_HSC_TEMP = 0xF1,
...
enum {
  ...
  PDPB_SENSOR_TEMP_1 = 0x4F,
  PDPB_SENSOR_TEMP_2 = 0x50,
  PDPB_SENSOR_TEMP_3 = 0x51,
  //PDPB_SENSOR_TEMP_4 = 0x52,
  PDPB_SENSOR_FLASH_TEMP_0 = 0x60,
...
enum {
  ...
  FCB_SENSOR_BJT_TEMP_1 = 0x57,
  FCB_SENSOR_BJT_TEMP_2 = 0x58,
};
