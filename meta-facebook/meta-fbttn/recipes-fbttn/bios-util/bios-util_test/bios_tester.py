...
from bios_plat_info_tester import BiosUtilPcieConfigUnitTest
...
def pcie_port_config_suite():
    ...
    """
    test_suite = unittest.TestSuite()
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_get_bios_pcie_port_config_sku1'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_get_bios_pcie_port_config_sku2'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_get_bios_pcie_port_config_sku3'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_get_bios_pcie_port_config_sku4'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_get_bios_pcie_port_config_sku5'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_get_bios_pcie_port_config_sku6'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_enable_bios_pcie_port_config_sku1'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_enable_bios_pcie_port_config_sku2'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_disable_bios_pcie_port_config_sku1'))
    test_suite.addTest(BiosUtilPciePortConfigUnitTest('test_disable_bios_pcie_port_config_sku2'))
