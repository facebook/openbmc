...
BmcFpgaComponent bs_fpga_fw("server", "fpga", MAX10_10M04, I2C_BS_FPGA_BUS, 0x40, BIC_FPGA_LOCATION);
#else
BmcFpgaComponent bs_fpga_fw("server", "fpga", MAX10_10M25, I2C_BS_FPGA_BUS, 0x40, BIC_FPGA_LOCATION);
#endif
