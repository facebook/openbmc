...
RDEPENDS:${PN} += " libwatchdog libmisc-utils libobmc-i2c libobmc-pmbus"
DEPENDS:append = " update-rc.d-native libwatchdog libmisc-utils libobmc-i2c libobmc-pmbus"

CXXFLAGS:prepend = "-DCONFIG_GALAXY100 "
