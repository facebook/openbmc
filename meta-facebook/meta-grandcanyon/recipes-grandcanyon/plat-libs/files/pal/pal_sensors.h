...
enum {
  ...
  ES_VR_FIVRA_TEMP_C = 0x10,   
  ES_VR_EHV_TEMP_C = 0x11, 
  ES_VR_VCCD_TEMP_C = 0x12,
  ES_VR_FAON_TEMP_C = 0x13,
  ES_THERMAL_MARGIN = 0x14,
  ES_CPU_TJMAX = 0x15,    
  ES_P12V_STBY = 0x20,
  ES_P3V3_STBY = 0x21,
  ES_P1V05_STBY = 0x22,
  ...
  ES_P1V2_STBY = 0x26,
  ES_P1V8_STBY = 0x27,
  ES_HSC_INPUT_VOLT_V = 0x29,
  ES_VR_VCCIN_VOLT_V = 0x2a,
  ES_VR_FIVRA_VOLT_V = 0x2b,
  ES_VR_EHV_VOLT_V = 0x2c,
  ES_VR_VCCD_VOLT_V = 0x2d,
  ES_VR_FAON_VOLT_V = 0x2e,
  ES_E1S_BOOt_DRIVE_VOLT_V = 0x2f,
  ES_HSC_OUTPUT_CURR_A = 0x30,
  ES_VR_VCCIN_CURR_A = 0x31,
  ES_VR_FIVRA_CURR_A = 0x32,   
  ES_VR_EHV_CURR_A = 0x33,   
  ES_VR_VCCD_CURR_A = 0x34,
  ES_VR_FAON_CURR_A = 0x35,
  ES_E1S_BOOt_DRIVE_CURR_A = 0x36,
  ES_CPU_PWR_W = 0x38,
  ES_HSC_INPUT_PWR_W = 0x39,
  ES_VR_VCCIN_PWR_W = 0x3a, 
  ES_VR_FIVRA_PWR_W = 0x3c,
...
enum {
  ...
  DPB_HSC_PWR = 0xDB,
  PTB_P48V_AUX = 0xDC,
  PTB_P12V_PU2_DC_MODULE = 0xDD,
  PTB_P12V_PU3_DC_MODULE = 0xDE,
  PTB_U19_ADC_MONITOR = 0xDF,
  PTB_U20_ADC_MONITOR = 0xE0,
  PTB_P48V_AUX_Current = 0xE1,
  PTB_P12V_PU2_DC_MODULE_Current = 0xE2,
  PTB_P12V_PU3_DC_MODULE_Current = 0xE3,
