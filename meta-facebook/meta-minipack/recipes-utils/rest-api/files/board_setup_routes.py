...
def setup_board_routes(app):
    ...
    app.router.add_get(board_routes[5], bhandler.rest_pimstatus_hdl)
    app.router.add_get(board_routes[6], bhandler.rest_firmware_info_pim_hdl)
    app.router.add_get(board_routes[7], bhandler.rest_firmware_info_scm_hdl)
    app.router.add_get(board_routes[8], bhandler.rest_firmware_info_all_hdl)
    ...
    app.router.add_get(board_routes[16], bhandler.rest_peutil_hdl)
    app.router.add_get(board_routes[17], bhandler.rest_seutil_hdl)
