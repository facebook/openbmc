...
class BiosUtilPciePortConfigUnitTest(unittest.TestCase):
    ...
    def test_enable_bios_pcie_port_config_sku1(self):
        ...
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "enable", "--scc_ioc", res_data)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "enable", "--flash1", self.test_pcie_port_config)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "enable", "--flash2", self.test_pcie_port_config)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "enable", "--nic", self.test_pcie_port_config)

        self.test_bios_pcie_port_config(1, plat_sku_file, "get", "", self.test_pcie_port_config)
    ...
    def test_enable_bios_pcie_port_config_sku2(self):
        ...
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "enable", "--scc_ioc", res_data)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "enable", "--iom_ioc", self.test_pcie_port_config)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "enable", "--nic", self.test_pcie_port_config)

        self.test_bios_pcie_port_config(4, plat_sku_file, "get", "", self.test_pcie_port_config)
    ...
    def test_disable_bios_pcie_port_config_sku1(self):
        ...
        plat_sku_file = TEST_PLATFORM_FILE_T5
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "disable", "--scc_ioc", res_data)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "disable", "--flash1", self.test_pcie_port_config)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "disable", "--flash2", self.test_pcie_port_config)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "disable", "--nic", self.test_pcie_port_config)

        self.test_bios_pcie_port_config(2, plat_sku_file, "get", "", self.test_pcie_port_config)
    ...
    def test_disable_bios_pcie_port_config_sku2(self):
        ...
        plat_sku_file = TEST_PLATFORM_FILE_T7
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "disable", "--scc_ioc", res_data)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "disable", "--iom_ioc", self.test_pcie_port_config)
        self.test_pcie_port_config = do_pcie_port_config_action(plat_sku_file, "disable", "--nic", self.test_pcie_port_config)

        self.test_bios_pcie_port_config(5, plat_sku_file, "get", "", self.test_pcie_port_config)
