...
binfiles += "setup-rest-api.sh plat_tree.py node_api.py node_sled.py node_mezz.py node_bmc.py node_vboot.py node_server_2s.py node_fruid.py node_sensors.py node_logs.py node_config.py"
