...
from unitTestUtil import UnitTestUtil
...
class WatchdogUtils:
    ...
    def __init__(self, unitTestUtil=None):
        """Create an instance of WatchdogUtil.
        """
        if unitTestUtil:
            self._testUtils = unitTestUtil
        else:
            self._testUtils = UnitTestUtil()
    ...
    def start_watchdog(self):
        ...
        self._testUtils.run_shell_cmd(cmd)
    ...
    def _read_ctrl_register(self):
        ...
        cmd_out = self._testUtils.run_shell_cmd(cmd)
