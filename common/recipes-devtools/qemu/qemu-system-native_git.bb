...
SRCREV = "a11f65ec1b8adcb012b89c92819cbda4dc25aaf1"
...
SRC_URI = " \
    ...
    file://0037-Trying-to-add-Cortex-A35.patch \
    file://0038-npcm8xx-Fix-flash-device-part-number.patch \
    file://0039-npcm8xx-Increase-ram-to-2GB.patch \
    file://0040-npcm8xx-Change-default-bios-path-to-pc-bios-npcm8xx_.patch \
    file://0041-npcm8xx-Init-INTCR4-GMMAP0-to-0x7F00_0000.patch \
    file://0042-npcm8xx-Auto-zero-extend-flash-images.patch \
    file://0043-hw-spi_gpio-remove-MOSI-pin.patch \
    file://0044-tests-avocado-boot_linux_console-Add-NPCM845-EVB.patch \
    file://0045-fbttn-Add-I2C-SCL-timeout-property.patch \
    file://0046-aspeed-Add-greatlakes-bmc.patch \
    file://0047-hw-misc-aspeed-Add-fby35-sb-cpld.patch \
    file://0048-hw-misc-aspeed-Add-intel-me.patch \
    file://0049-hw-misc-aspeed-Add-fby35-server-board-bridge-IC.patch \
    file://0050-fby35-Add-CPLD-and-BIC-as-I2C-devices.patch \
    file://0051-hw-i2c-pca954x-Add-method-to-get-channels.patch \
    file://0052-aspeed-Expose-i2c-buses-to-machine.patch \
    file://0053-fby35-Setup-I2C-devices-and-GPIO-s.patch \
    file://0054-fby35-Add-motherboard-fru-EEPROM-to-BIC.patch \
    file://0055-hw-i2c-aspeed-Add-bus-ID-to-all-trace-events.patch \
    file://0056-hw-i2c-aspeed-Add-slave-event-traces.patch \
    file://0057-hw-i2c-aspeed-Fix-bus-derivation-for-slave-events.patch \
    file://0058-qemu-Add-i2c-devices-to-oby35-cl.patch \
    file://0059-tests-Rename-aspeed_i2c-test-to-i2c-netdev2-test.patch \
    file://0060-hw-misc-add-a-toy-i2c-echo-device.patch \
    file://0061-hw-i2c-aspeed-Fix-interrupt-status-flag-names.patch \
    file://0062-tests-Create-qtest-for-Aspeed-I2C-controller.patch \
    file://0063-aspeed-Add-Sandia.patch \
    file://0064-npcm8xx-Enable-EL3.patch \
    file://0065-npcm8xx-Allow-bios-to-be-omitted.patch \
    file://0066-Revert-Remove-the-slirp-submodule-i.e.-compile-only-.patch \
"
