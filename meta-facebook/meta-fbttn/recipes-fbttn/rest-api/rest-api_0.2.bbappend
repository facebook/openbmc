...
binfiles += "setup-rest-api.sh plat_tree.py node_api.py node_mezz.py node_bmc.py node_server.py node_fruid.py node_sensors.py node_logs.py node_config.py node_dpb.py node_iom.py node_scc.py node_health.py node_identify.py node_fans.py node_bios.py node_enclosure.py"
