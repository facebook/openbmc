...
case "$sku_type" in
   "0")
       ...
       cp /etc/FSC_MINILAKETB_PVT_4TL_config.json ${default_fsc_config_path}
   ;;
   "34")
       echo "Run FSC 2 GPs and 2 TLs Config"
       cp /etc/FSC_MINILAKETB_PVT_2GP_2TL_config.json ${default_fsc_config_path}
   ;;
   "17")
       echo "Run FSC 2 CFs and 2 TLs Config"
       cp /etc/FSC_MINILAKETB_PVT_2CF_2TL_config.json ${default_fsc_config_path}
   ;;
