...
TestItem = [
#['sol.sh', 'sol.sh', '', '0x', '', '', '', '', '', '', ''],
['slot_id', 'cat /sys/class/i2c-adapter/i2c-12/12-0031/slotid', '>=','0', '', '', '', '', '', '', ''],
['SCM_slot_id', 'i2cget -f -y 0 0x3e 0x03', '>=','0', '', '', '', '', '', '', ''],
['board id', 'i2cget -f -y 6 0x27 0x0', '>=', '0', '', '', '', '', '', '', ''],
#####BUS1######
['BUS(1) rertimer(0x18)', 'i2cget -f -y 0 0x18 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 0 0x18'],
['BUS(1) ADM1278(0x10)', 'i2cget -f -y 11 0x10 0x1', '>=', '0', 'i2cget -f -y 12 0x31 0x05', '=', '0', '', '', '', 'i2cdump -f -y 0 0x10'],
['BUS(1) PCA9534(0x21)', 'i2cget -f -y 0 0x21 0x0', '>=', '0', 'i2cget -f -y 12 0x31 0x05', '=', '0', '', '', '', 'i2cdump -f -y 0 0x21'],
['BUS(1) EEPROM(0x52)', 'i2cget -f -y 0 0x52 0x0', '>=', '0', 'i2cget -f -y 12 0x31 0x05', '=', '0', '', '', '', 'i2cdump -f -y 0 0x52'],
['BUS(1) EC(0x33)', 'i2cget -f -y 0 0x33 0x0', '>=', '0', 'i2cset -f -y 0 0x3e 0x18 0x01', '', '', '', '', '', 'i2cdump -f -y 0 0x33'],
['BUS(1) SCM_CPLD(0x3e)', 'i2cget -f -y 0 0x3e 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 0 0x3e'],
['BUS(1) EEPROM(0x54)', 'i2cget -f -y 0 0x54 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 0 0x54'],

######BUS2#######
['BUS(2) IR3584(0x10)', 'i2cget -f -y 1 0x10 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 1 0x10'],
['BUS(2) IR3584(0x11)', 'i2cget -f -y 1 0x11 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 1 0x11'],
['BUS(2) retimer(0x18)', 'i2cget -f -y 1 0x18 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 1 0x18'],

######BUS3#######
['BUS(3) pwr1014a(0x40)', 'i2cget -f -y 2 0x40 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 2 0x40'],

######BUS5#######

######BUS6#######
['BUS(6) TPM(0x20)', 'i2cget -f -y 5 0x20 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 5 0x20'],

######BUS7#######
['BUS(7) PCF8574(0x27)', 'i2cget -f -y 6 0x27 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 6 0x27'],
['BUS(7) EEPROM(0x51)', 'i2cget -f -y 6 0x51 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 6 0x51'],

######BUS10#######
['BUS(10) EEPROM(0x50)', 'i2cget -f -y 9 0x50 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 9 0x50'],

######BUS12#######
['BUS(12) ADM1278(0x10)', 'i2cget -f -y 11 0x10 0x1', '>=', '0', 'i2cget -f -y 12 0x31 0x05', '=', '0', '', '', '', 'i2cdump -f -y 11 0x10'],

######BUS13#######
['BUS(13) SYS_CPLD(0x31)', 'i2cget -f -y 12 0x31 0x0', '>=', '0', '', '', '', '', '', '', 'i2cdump -f -y 12 0x31'],
['BUS(13) PCA9541(0x74)', 'i2cget -f -y 12 0x74 0x0', '>=', '0', 'i2cget -f -y 12 0x31 0x3', '<', '0x8', '', '', '', 'i2cdump -f -y 12 0x74'],

#####sys led######
['SYS_LED', 'i2cset -f -y 12 0x31 0x06 0xff', '', '', '', '', '', '', '', '', ''],

['BIOS-Flash', 'bios_flash.sh', '', 'W25Q64.V', 'i2cset -f -y 0 0x3e 0x18 0x0', '', '', '', '', '', ''],
