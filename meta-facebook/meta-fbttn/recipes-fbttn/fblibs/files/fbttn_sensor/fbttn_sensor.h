...
enum{
  ...
  IOM_SENSOR_M2_1_TEMP = 0x48,    // type V only
  IOM_SENSOR_M2_2_TEMP = 0x49,    // type V only
...
enum{
  ...
  DPB_SENSOR_FAN0_FRONT = 0x69,
  DPB_SENSOR_FAN1_FRONT = 0x6A,
  DPB_SENSOR_FAN2_FRONT = 0x6B,
  DPB_SENSOR_FAN3_FRONT = 0x6C,
  DPB_SENSOR_FAN0_REAR = 0x6D,
  DPB_SENSOR_FAN1_REAR = 0x6E,
  DPB_SENSOR_FAN2_REAR = 0x6F,
  DPB_SENSOR_FAN3_REAR = 0x70,
  DPB_SENSOR_HSC_POWER = 0x71,
  DPB_SENSOR_HSC_VOLT = 0x72,
  DPB_SENSOR_HSC_CURR = 0x73,
#if 0 // TODO: A2, waiting for IPMB
