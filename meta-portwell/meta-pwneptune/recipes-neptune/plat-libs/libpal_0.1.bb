...
DEPENDS += "libkv libedb plat-utils libipmi libipmb obmc-pal libme libvr libgpio libsensor-correction"
...
RDEPENDS_${PN} += " libkv libedb libme libipmb libvr libsensor-correction"
