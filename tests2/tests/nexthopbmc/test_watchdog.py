...
class WatchdogTest(WatchdogTest, unittest.TestCase):
    def set_kill_watchdog_daemon_cmd(self):
        """
        Override to use watchdog.service instead of fscd.
        nexthopbmc uses the standard Linux watchdog daemon (watchdog.service) with
    ...
    def test_watchdog_start_stop(self):
        ...
        Note: Override because nexthopbmc uses the standard Linux watchdog daemon which
