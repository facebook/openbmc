...
// SCM Sensors
#define SCM_UCD90320_DEVICE I2C_DEV_HWMON_DIR(9-0011)
...
// PIM Sensors
#define PIM_TCA9548A_DEVICE_ADDR 0x16
#define PIM_TPS546D24_DEVICE_ADDR 0x18
...
enum {
  ...
  PIM8DDM_SENSOR_COUNT = PIM_ISL_IOUT_LOOP2 - 1,
};
