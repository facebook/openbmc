...
static sensor_desc_t cri_sensor[] =
{
  ...
  {"FAN2_IN:"       , MB_SNR_FAN2_TACH_IN     , "RPM" , FRU_MB, 0},
  {"FAN2_OUT:"      , MB_SNR_FAN2_TACH_OUT    , "RPM" , FRU_MB, 0},
  {"FAN3_IN:"       , MB_SNR_FAN3_TACH_IN     , "RPM" , FRU_MB, 0},
  {"FAN3_OUT:"      , MB_SNR_FAN3_TACH_OUT    , "RPM" , FRU_MB, 0},
  {"FAN4_IN:"       , MB_SNR_FAN4_TACH_IN     , "RPM" , FRU_MB, 0},
  {"FAN4_OUT:"      , MB_SNR_FAN4_TACH_OUT    , "RPM" , FRU_MB, 0},
  {"FAN5_IN:"       , MB_SNR_FAN5_TACH_IN     , "RPM" , FRU_MB, 0},
  {"FAN5_OUT:"      , MB_SNR_FAN5_TACH_OUT    , "RPM" , FRU_MB, 0},
  {"Inlet_TEMP:"    , MB_SNR_INLET_TEMP       , "C"   , FRU_MB, 0},
  {"P0_VR_TEMP:" , MB_SNR_VR_CPU0_VCCIN_TEMP  , "C"   , FRU_MB, 0},
  {"P1_VR_TEMP:" , MB_SNR_VR_CPU1_VCCIN_TEMP  , "C"   , FRU_MB, 0},
  {"P0_VR_Pwr:"  , MB_SNR_VR_CPU0_VCCIN_POWER , "W"   , FRU_MB, 0},
  {"P1_VR_Pwr:"  , MB_SNR_VR_CPU1_VCCIN_POWER , "W"   , FRU_MB, 1},
  {"CPU0_DIMMA_TEMP:" , MB_SNR_CPU0_DIMM_GRPA_TEMP , "C"   , FRU_MB, 0},
  {"CPU0_DIMMB_TEMP:" , MB_SNR_CPU0_DIMM_GRPB_TEMP , "C"   , FRU_MB, 0},
  {"CPU0_DIMMC_TEMP:" , MB_SNR_CPU0_DIMM_GRPC_TEMP , "C"   , FRU_MB, 0},
  {"CPU0_DIMMD_TEMP:" , MB_SNR_CPU0_DIMM_GRPD_TEMP , "C"   , FRU_MB, 0},
  {"CPU0_DIMME_TEMP:" , MB_SNR_CPU0_DIMM_GRPE_TEMP , "C"   , FRU_MB, 0},
  {"CPU0_DIMMF_TEMP:" , MB_SNR_CPU0_DIMM_GRPF_TEMP , "C"   , FRU_MB, 0},
  {"CPU1_DIMMA_TEMP:" , MB_SNR_CPU1_DIMM_GRPA_TEMP , "C"   , FRU_MB, 0},
  {"CPU1_DIMMB_TEMP:" , MB_SNR_CPU1_DIMM_GRPB_TEMP , "C"   , FRU_MB, 0},
  {"CPU1_DIMMC_TEMP:" , MB_SNR_CPU1_DIMM_GRPC_TEMP , "C"   , FRU_MB, 0},
  {"CPU1_DIMMD_TEMP:" , MB_SNR_CPU1_DIMM_GRPD_TEMP , "C"   , FRU_MB, 0},
  {"CPU1_DIMME_TEMP:" , MB_SNR_CPU1_DIMM_GRPE_TEMP , "C"   , FRU_MB, 0},
  {"CPU1_DIMMF_TEMP:" , MB_SNR_CPU1_DIMM_GRPF_TEMP , "C"   , FRU_MB, 0},
};
...
int plat_get_me_status(uint8_t fru, char *status)
{
  ...
  len = 0;
  lib_ipmb_handle(0x5, (uint8_t *)req, 7, (uint8_t *)res, &len);
  if (len > 7 && res->cc == 0) {
    if (res->data[2] & 0x80)
    ...
    syslog(LOG_WARNING, "lib_ipmb_handle len: %d res: %d", len, res->cc);
...
int plat_get_board_id(char *id)
{
  ...
  if (!pal_get_platform_id(BOARD_SKU_ID, &byte)){
    sprintf(id, "%d%d%d%d",
      (byte & (1<<3))?1:0,
      (byte & (1<<2))?1:0,
      (byte & (1<<1))?1:0,
