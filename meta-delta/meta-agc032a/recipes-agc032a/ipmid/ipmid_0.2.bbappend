...
LDFLAGS:append = " -lwedge_eeprom -lfruid -lpal -lobmc-i2c -llog"

DEPENDS:append = " libwedge-eeprom libpal libipmi libfruid libobmc-i2c liblog update-rc.d-native libgpio"
RDEPENDS:${PN} += " libwedge-eeprom libpal libipmi libfruid libobmc-i2c liblog libgpio bash"
