/*
 * DBusHPExtDectectionFruInterface.h
 *
...
//DBus interface for for Frus which supports external hotplug detection
class DBusHPExtDectectionFruInterface: public DBusInterfaceBase {
  public:
    /**
     ...
     */
    DBusHPExtDectectionFruInterface();
  ...
  private:
    ...
    /**
     * Callback for setFruAvailable method
     * Returns whether operation is susccessful or not
     */
    static void setFruAvailable(GDBusConnection*       connection,
                                const char*            objectPath,
                                GVariant*              parameters,
                                GDBusMethodInvocation* invocation,
                                gpointer               arg);
