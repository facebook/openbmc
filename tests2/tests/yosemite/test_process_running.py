...
class ProcessRunningTest(BaseProcessRunningTest, unittest.TestCase):
    def set_processes(self):
        self.expected_process = [
            ...
            "/usr/local/bin/mTerm_server slot1 /dev/ttyS2",
            "/usr/local/bin/mTerm_server slot2 /dev/ttyS1",
            "/usr/local/bin/mTerm_server slot3 /dev/ttyS4",
            "/usr/local/bin/mTerm_server slot4 /dev/ttyS3",
            ...
            "/usr/local/bin/ipmbd 1 2",
            "/usr/local/bin/ipmbd 5 4",
            "/usr/local/bin/ipmbd 7 3",
        ]
