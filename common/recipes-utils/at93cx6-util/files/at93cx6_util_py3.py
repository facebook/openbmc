...
def access_parser(ap):
    ...
    spi_group.add_argument(
        ...
        help="The GPIO number for SPI CS pin " "(default: %(default)s)",
    )
    spi_group.add_argument(
        "--clk",
        type=int,
        default=SPI_CLK_DEFAULT,
        help="The GPIO number for SPI CLK pin " "(default: %(default)s)",
    )
    spi_group.add_argument(
        "--mosi",
        type=int,
        default=SPI_MOSI_DEFAULT,
        help="The GPIO number for SPI MOSI pin " "(default: %(default)s)",
    )
    spi_group.add_argument(
        "--miso",
        type=int,
        default=SPI_MISO_DEFAULT,
        help="The GPIO number for SPI MISO pin " "(default: %(default)s)",
    )
