...
enum {
  ...
  BIC_GPV3_P1V8_TEMP = 0x96,
  BIC_GPV3_P0V84_TEMP = 0x97,
  ...
  BIC_GPV3_P1V8_VOLTAGE = 0x9D,
  BIC_GPV3_P0V84_VOLTAGE = 0x9E,
  ...
  BIC_GPV3_P12V_STBY_VOL = 0x98,
  BIC_GPV3_P3V3_STBY_AUX_VOL = 0x99,
  BIC_GPV3_P1V8_VOL = 0x9F,
  BIC_GPV3_P3V3_STBY1_CURRENT = 0xAF,
  BIC_GPV3_P3V3_STBY2_CURRENT = 0xA8,
  BIC_GPV3_P3V3_STBY3_CURRENT = 0xA9,
  BIC_GPV3_P1V8_CURRENT = 0xAC,
  BIC_GPV3_P0V84_CURRENT = 0xAD,
  ...
  BIC_GPV3_P1V8_POWER = 0x4C,
  BIC_GPV3_P0V84_POWER = 0x4D,
