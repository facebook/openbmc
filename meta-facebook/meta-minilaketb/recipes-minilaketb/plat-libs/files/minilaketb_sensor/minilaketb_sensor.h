...
enum {
  ...
  BIC_SENSOR_LIQUID_PUMP_TACH = 0x2D,
  BIC_SENSOR_LIQUID_PUMP_PWM = 0x2F,
...
enum{ //ken
    BIC_T6A_SENSOR_MB_OUTLET_TEMP = 0x01,
    BIC_T6A_SENSOR_MB_INLET_TEMP = 0x07,
    BIC_T6A_SENSOR_PCH_TEMP = 0x08,
    BIC_T6A_SENSOR_VCCIN_VR_TEMP = 0x80,
    BIC_T6A_SENSOR_1V05MIX_VR_TEMP = 0x81,
    BIC_T6A_SENSOR_SOC_TEMP = 0x05,
    BIC_T6A_SENSOR_SOC_THERM_MARGIN = 0x09,
    BIC_T6A_SENSOR_VDDR_VR_TEMP = 0x82,
    BIC_T6A_SENSOR_SOC_DIMMA0_TEMP = 0xB4,
    BIC_T6A_SENSOR_SOC_DIMMA1_TEMP = 0xB5,
    BIC_T6A_SENSOR_SOC_DIMMB0_TEMP = 0xB6,
    BIC_T6A_SENSOR_SOC_DIMMB1_TEMP = 0xB7,
    BIC_T6A_SENSOR_SOC_PACKAGE_PWR = 0x2C,
    BIC_T6A_SENSOR_VCCIN_VR_POUT = 0x8B,
    BIC_T6A_SENSOR_VDDR_VR_POUT = 0x8D,
    BIC_T6A_SENSOR_SOC_TJMAX = 0x30,
    BIC_T6A_SENSOR_P3V3_MB = 0xD0,
    BIC_T6A_SENSOR_P12V_MB = 0xD2,
    BIC_T6A_SENSOR_P1V05_PCH = 0xD3,
    BIC_T6A_SENSOR_P3V3_STBY_MB = 0xD5,
    BIC_T6A_SENSOR_P5V_STBY_MB = 0xD6,
    BIC_T6A_SENSOR_PV_BAT = 0xD7,
    BIC_T6A_SENSOR_PVDDR = 0xD8,
    BIC_T6A_SENSOR_P1V05_MIX = 0x8E,
    BIC_T6A_SENSOR_1V05MIX_VR_CURR = 0x84,
    BIC_T6A_SENSOR_VDDR_VR_CURR = 0x85,
    BIC_T6A_SENSOR_VCCIN_VR_CURR = 0x83,
    BIC_T6A_SENSOR_VCCIN_VR_VOL = 0x88,
    BIC_T6A_SENSOR_VDDR_VR_VOL = 0x8A,
    BIC_T6A_SENSOR_P1V05MIX_VR_VOL = 0x89,
    BIC_T6A_SENSOR_P1V05MIX_VR_Pout = 0x8C,
    BIC_T6A_SENSOR_INA230_POWER = 0x29,
    BIC_T6A_SENSOR_INA230_VOL = 0x2A,
};
