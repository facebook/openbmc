...
PAL_SENSOR_MAP mb_sensor_map[] = {
  ...
  {"OUTLET_L_TEMP", TEMP_OUTLET_L, read_mb_temp, true, {75.0, 0, 0, 10.0, 0, 0, 0, 0}, TEMP}, //0x10
  ...
  {"INLET_R_TEMP", TEMP_INLET_R, read_mb_temp, true, {55.0, 0, 0, 10.0, 0, 0, 0, 0}, TEMP}, //0x13
