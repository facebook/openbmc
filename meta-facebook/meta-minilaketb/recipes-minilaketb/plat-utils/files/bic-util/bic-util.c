...
util_get_gpio(uint8_t slot_id) {
  ...
  printf(" 2 %s: %d\n", gpio_pin_name[2], t->bits.pvddr_vrhot_n);
  printf(" 3 %s: %d\n", gpio_pin_name[3], t->bits.pvccin_vrhot_n);
  printf(" 4 %s: %d\n", gpio_pin_name[4], t->bits.fm_fast_prochot_n);
  printf(" 5 %s: %d\n", gpio_pin_name[5], t->bits.pchhot_cpu_n);
  printf(" 6 %s: %d\n", gpio_pin_name[6], t->bits.fm_cpld_cpu_dimm_event_co_n);
  printf(" 7 %s: %d\n", gpio_pin_name[7], t->bits.fm_cpld_bdxde_thermtrip_n);
  printf(" 8 %s: %d\n", gpio_pin_name[8], t->bits.thermtrip_pch_n);
  printf(" 9 %s: %d\n", gpio_pin_name[9], t->bits.fm_cpld_fivr_fault);
  printf("10 %s: %d\n", gpio_pin_name[10], t->bits.fm_bdxde_caterr_lvt3_n);
  printf("11 %s: %d\n", gpio_pin_name[11], t->bits.fm_bdxde_err2_lvt3_n);
  printf("12 %s: %d\n", gpio_pin_name[12], t->bits.fm_bdxde_err1_lvt3_n);
  printf("13 %s: %d\n", gpio_pin_name[13], t->bits.fm_bdxde_err0_lvt3_n);
  printf("14 %s: %d\n", gpio_pin_name[14], t->bits.slp_s4_n);
  printf("15 %s: %d\n", gpio_pin_name[15], t->bits.fm_nmi_event_bmc_n);
  printf("16 %s: %d\n", gpio_pin_name[16], t->bits.fm_smi_bmc_n);
  printf("17 %s: %d\n", gpio_pin_name[17], t->bits.rst_pltrst_bmc_n);
  printf("18 %s: %d\n", gpio_pin_name[18], t->bits.fp_rst_btn_buf_n);
  printf("19 %s: %d\n", gpio_pin_name[19], t->bits.bmc_rst_btn_out_n);
  printf("20 %s: %d\n", gpio_pin_name[20], t->bits.fm_bde_post_cmplt_n);
  printf("21 %s: %d\n", gpio_pin_name[21], t->bits.fm_bdxde_slp3_n);
  printf("22 %s: %d\n", gpio_pin_name[22], t->bits.fm_pwr_led_n);
  printf("23 %s: %d\n", gpio_pin_name[23], t->bits.pwrgd_pvccin);
  printf("24 %s: %d\n", gpio_pin_name[24], t->bits.svr_id0);
  printf("25 %s: %d\n", gpio_pin_name[25], t->bits.svr_id1);
  printf("26 %s: %d\n", gpio_pin_name[26], t->bits.svr_id2);
  printf("27 %s: %d\n", gpio_pin_name[27], t->bits.svr_id3);
