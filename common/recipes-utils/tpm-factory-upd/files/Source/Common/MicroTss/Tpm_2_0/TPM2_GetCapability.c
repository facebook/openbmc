...
)
{
	...
	do
	{
		...
		unReturnValue |= Platform_MemorySet(pMoreData, 0x00, sizeof(TSS_TPMI_YES_NO));
		unReturnValue |= Platform_MemorySet(pCapabilityData, 0x00, sizeof(TSS_TPMS_CAPABILITY_DATA));
