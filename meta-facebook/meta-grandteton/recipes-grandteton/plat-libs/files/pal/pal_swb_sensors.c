...
{
  return get_pldm_sensor(SWB_BUS_ID, SWB_BIC_EID, sensor_num, value);
}
...
PAL_SENSOR_MAP swb_sensor_map[] = {
  ...
  {"NIC0_OPTIC_TEMP", 0, get_swb_sensor, true, {70, 0, 0, 5, 0, 0, 0, 0}, TEMP}, //0xC0
  {"NIC1_OPTIC_TEMP", 0, get_swb_sensor, true, {70, 0, 0, 5, 0, 0, 0, 0}, TEMP}, //0xC1
  {"NIC2_OPTIC_TEMP", 0, get_swb_sensor, true, {70, 0, 0, 5, 0, 0, 0, 0}, TEMP}, //0xC2
  {"NIC3_OPTIC_TEMP", 0, get_swb_sensor, true, {70, 0, 0, 5, 0, 0, 0, 0}, TEMP}, //0xC3
  {"NIC4_OPTIC_TEMP", 0, get_swb_sensor, true, {70, 0, 0, 5, 0, 0, 0, 0}, TEMP}, //0xC4
  {"NIC5_OPTIC_TEMP", 0, get_swb_sensor, true, {70, 0, 0, 5, 0, 0, 0, 0}, TEMP}, //0xC5
  {"NIC6_OPTIC_TEMP", 0, get_swb_sensor, true, {70, 0, 0, 5, 0, 0, 0, 0}, TEMP}, //0xC6
  {"NIC7_OPTIC_TEMP", 0, get_swb_sensor, true, {70, 0, 0, 5, 0, 0, 0, 0}, TEMP}, //0xC7
