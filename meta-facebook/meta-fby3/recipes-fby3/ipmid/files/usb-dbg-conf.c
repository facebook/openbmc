...
// GPv3 sensors
  ...
  {"GP3 PESW VR P:"        , BIC_GPV3_VR_P0V84_POWER       , "W"    , FRU_ALL, 2},
  {"GP3 PESW VR T:"        , BIC_GPV3_VR_P0V84_TEMP        , "C"    , FRU_ALL, 2},
  {"GP3 P1V8 Pwr:"         , BIC_GPV3_VR_P1V8_POWER        , "W"    , FRU_ALL, 2},
  {"GP3 P1V8 Temp:"        , BIC_GPV3_VR_P1V8_TEMP         , "C"    , FRU_ALL, 2},
...
// CWC sensors
{
  {"CWC Outlet Temp:"      , BIC_CWC_SENSOR_OUTLET_TEMP_T  , "C"    , FRU_CWC, 2},
  {"CWC PESW Temp:"        , BIC_CWC_SENSOR_PCIE_SWITCH_T  , "C"    , FRU_CWC, 2},
  {"CWC P12V STBY:"        , BIC_CWC_SENSOR_NUM_V_12       , "V"    , FRU_CWC, 2},
  {"CWC P3V3 STBY:"        , BIC_CWC_SENSOR_NUM_V_3_3_S    , "V"    , FRU_CWC, 2},
  {"CWC P1V8 Vol:"         , BIC_CWC_SENSOR_NUM_V_1_8      , "V"    , FRU_CWC, 2},
  {"CWC P5V Vol:"          , BIC_CWC_SENSOR_NUM_V_5        , "V"    , FRU_CWC, 2},
  {"CWC P1V8 VR Pwr:"      , BIC_CWC_SENSOR_NUM_P_P1V8_VR  , "W"    , FRU_CWC, 2},
  {"CWC P1V8 VR Vol:"      , BIC_CWC_SENSOR_NUM_V_P1V8_VR  , "V"    , FRU_CWC, 2},
  {"CWC P1V8 VR Cur:"      , BIC_CWC_SENSOR_NUM_C_P1V8_VR  , "Amps" , FRU_CWC, 2},
  {"CWC P1V8 VR Temp:"     , BIC_CWC_SENSOR_NUM_T_P1V8_VR  , "C"    , FRU_CWC, 2},
  {"CWC P0V84 VR Pwr:"     , BIC_CWC_SENSOR_NUM_P_P0V84_VR , "W"    , FRU_CWC, 2},
  {"CWC P0V84 VR Vol:"     , BIC_CWC_SENSOR_NUM_V_P0V84_VR , "V"    , FRU_CWC, 2},
  {"CWC P0V84 VR Cur:"     , BIC_CWC_SENSOR_NUM_C_P0V84_VR , "Amps" , FRU_CWC, 2},
  {"CWC P0V84VR Temp:"     , BIC_CWC_SENSOR_NUM_T_P0V84_VR , "C"    , FRU_CWC, 2},
  {"CWC P3V3 AUX Pwr:"     , BIC_CWC_SENSOR_NUM_P_3V3_AUX  , "W"    , FRU_CWC, 2},
  {"CWC P3V3 AUX Vol:"     , BIC_CWC_SENSOR_NUM_V_3V3_AUX  , "V"    , FRU_CWC, 2},
  {"CWC P3V3 AUX Cur:"     , BIC_CWC_SENSOR_NUM_C_3V3_AUX  , "Amps" , FRU_CWC, 2},
  {"CWC HSC CWC Pwr:"      , BIC_CWC_SENSOR_NUM_P_HSC_CWC  , "W"    , FRU_CWC, 2},
  {"CWC HSC CWC Vol:"      , BIC_CWC_SENSOR_NUM_V_HSC_CWC  , "V"    , FRU_CWC, 2},
  {"CWC HSC CWC Cur:"      , BIC_CWC_SENSOR_NUM_C_HSC_CWC  , "Amps" , FRU_CWC, 2},
  {"CWC HSC CWC Temp:"     , BIC_CWC_SENSOR_NUM_T_HSC_CWC  , "C"    , FRU_CWC, 2},
  {"CWC HSC BOT Pwr:"      , BIC_CWC_SENSOR_NUM_P_HSC_BOT  , "W"    , FRU_CWC, 2},
  {"CWC HSC BOT Vol:"      , BIC_CWC_SENSOR_NUM_V_HSC_BOT  , "V"    , FRU_CWC, 2},
  {"CWC HSC BOT Cur:"      , BIC_CWC_SENSOR_NUM_C_HSC_BOT  , "Amps" , FRU_CWC, 2},
  {"CWC HSC BOT Temp:"     , BIC_CWC_SENSOR_NUM_T_HSC_BOT  , "C"    , FRU_CWC, 2},
  {"CWC HSC TOP Pwr:"      , BIC_CWC_SENSOR_NUM_P_HSC_TOP  , "W"    , FRU_CWC, 2},
  {"CWC HSC TOP Vol:"      , BIC_CWC_SENSOR_NUM_V_HSC_TOP  , "V"    , FRU_CWC, 2},
  {"CWC HSC TOP Cur:"      , BIC_CWC_SENSOR_NUM_C_HSC_TOP  , "Amps" , FRU_CWC, 2},
  {"CWC HSC TOP Temp:"     , BIC_CWC_SENSOR_NUM_T_HSC_TOP  , "C"    , FRU_CWC, 2},
  {"CWC PESW Pwr:"         , BIC_CWC_SENSOR_NUM_P_PESW     , "W"    , FRU_CWC, 2},
};
