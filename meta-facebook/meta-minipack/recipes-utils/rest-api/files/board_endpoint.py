...
class boardApp_Handler:
    ...
    async def rest_usb2i2c_reset_hdl(self, request):
        usb2i2c = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_fruid_scm_hdl(self, request):
        fruid_scm = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_pim_present_hdl(self, request):
        pim_present = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_piminfo_hdl(self, request):
        piminfo = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_pimserial_hdl(self, request):
        pimserial = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_pimstatus_hdl(self, request):
        pimstatus = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_firmware_info_pim_hdl(self, request):
        firmware_info = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_firmware_info_all_hdl(self, request):
        all_fw_ver = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_peutil_hdl(self, request):
        ...
        peutil = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_seutil_hdl(self, request):
        seutil = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_system_led_info_hdl(self, request):
        system_led_info = await asyncio.get_running_loop().run_in_executor(
    ...
    async def rest_pimdetails_hdl(self, request):
        pim_details = await asyncio.get_running_loop().run_in_executor(
