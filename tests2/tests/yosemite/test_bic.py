...
class BicSlot2Test(CommonBicTest, unittest.TestCase):
    def set_bic_cmd(self):
...
class BicSlot3Test(CommonBicTest, unittest.TestCase):
    def set_bic_cmd(self):
...
class BicSlot4Test(CommonBicTest, unittest.TestCase):
    def set_bic_cmd(self):
