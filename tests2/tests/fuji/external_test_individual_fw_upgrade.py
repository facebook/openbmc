...
from tests.fuji.test_data.firmware_upgrade.firmware_upgrade_config import FwUpgradeTest


class Pim16OFwUpgradeTest(FwUpgradeTest, unittest.TestCase):
    """
    Individual test for PIM 16O FPGA
    """

    def test_16o_fpga_fw_upgrade(self):
        super().do_external_firmware_upgrade("16o_fpga")


class Pim16QFwUpgradeTest(FwUpgradeTest, unittest.TestCase):
    """
    Individual test for PIM 16Q FPGA
    """

    def test_16q_fpga_fw_upgrade(self):
...
class IobFPGAFwUpgradeTest(FwUpgradeTest, unittest.TestCase):
    ...
    def test_iob_fpga_fw_upgrade(self):
