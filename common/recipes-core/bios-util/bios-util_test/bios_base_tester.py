...
TEST_BIOS_UTIL_DEFAULT_CONFIG = './test-data/config-bios-example-default-support-test.json'
...
class BaseBiosUtilUnitTest(unittest.TestCase):
    ...
    def define_biosutil(self, config=TEST_BIOS_UTIL_CONFIG, default_config=TEST_BIOS_UTIL_DEFAULT_CONFIG, argv=sys.argv):
