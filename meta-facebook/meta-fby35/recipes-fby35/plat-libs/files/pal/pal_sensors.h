...
enum {
  ...
  //BIC 1OU WF Sensors
  BIC_1OU_WF_SENSOR_TEMP = 0x50,
  BIC_1OU_WF_SENSOR_CXL_EMC1412_TEMP = 0x51,
  BIC_1OU_WF_SENSOR_SSD0_TEMP = 0x52,
  BIC_1OU_WF_SENSOR_SSD1_TEMP = 0x53,
  BIC_1OU_WF_SENSOR_SSD2_TEMP = 0x54,
  BIC_1OU_WF_SENSOR_P0V9ASICD_TEMP = 0x55,
  BIC_1OU_WF_SENSOR_P0V9ASICA1_TEMP = 0x56,
  BIC_1OU_WF_SENSOR_P0V9ASICA2_TEMP = 0x57,
  BIC_1OU_WF_SENSOR_PVDDQAB_TEMP = 0x58,
  BIC_1OU_WF_SENSOR_CXL_ON_DIE_TEMP = 0x59,
  BIC_1OU_WF_SENSOR_DIMMA_TEMP = 0x5A,
  BIC_1OU_WF_SENSOR_DIMMB_TEMP = 0x5B,
  BIC_1OU_WF_SENSOR_12V_STBY_VOL = 0x60,
  BIC_1OU_WF_SENSOR_3V3_STBY_VOL = 0x61,
  BIC_1OU_WF_SENSOR_12V_E1S_VOL = 0x62,
  BIC_1OU_WF_SENSOR_VDD_1V2_VOL = 0x63,
  BIC_1OU_WF_SENSOR_VDD_1V8_VOL = 0x64,
  BIC_1OU_WF_SENSOR_3V3_E1S_VOL = 0x65,
  BIC_1OU_WF_SENSOR_PVPP2V5AB_VOL = 0x66,
  BIC_1OU_WF_SENSOR_PVTT0V6AB_VOL = 0x67,
  BIC_1OU_WF_SENSOR_5V_STBY_VOL = 0x68,
  BIC_1OU_WF_SENSOR_12V_E1S_INA230_VOL = 0x69,
  BIC_1OU_WF_SENSOR_PVPPAB_INA230_VOL = 0x6A,
  BIC_1OU_WF_SENSOR_P0V9ASICD_VOL = 0x6B,
  BIC_1OU_WF_SENSOR_P0V9ASICA1_VOL = 0x6C,
  BIC_1OU_WF_SENSOR_P0V9ASICA2_VOL = 0x6D,
  BIC_1OU_WF_SENSOR_PVDDQAB_VOL = 0x6E,
  BIC_1OU_WF_SENSOR_E1S_12V_INA230_CUR = 0x70,
  BIC_1OU_WF_SENSOR_PVPPAB_INA230_CUR = 0x71,
  BIC_1OU_WF_SENSOR_P0V9ASICD_CUR = 0x72,
  BIC_1OU_WF_SENSOR_P0V9ASICA1_CUR = 0x73,
  BIC_1OU_WF_SENSOR_P0V9ASICA2_CUR = 0x74,
  BIC_1OU_WF_SENSOR_PVDDQAB_CUR = 0x75,
  BIC_1OU_WF_SENSOR_E1S_12V_INA230_PWR = 0x78,
  BIC_1OU_WF_SENSOR_PVPPAB_INA230_PWR = 0x79,
  BIC_1OU_WF_SENSOR_P0V9ASICD_PWR = 0x7A,
  BIC_1OU_WF_SENSOR_P0V9ASICA1_PWR = 0x7B,
  BIC_1OU_WF_SENSOR_P0V9ASICA2_PWR = 0x7C,
  BIC_1OU_WF_SENSOR_PVDDQAB_PWR = 0x7D,
