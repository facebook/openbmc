...
DEPENDS += " libpal update-rc.d-native libgpio-ctrl libobmc-sensors apml libnetlakenext-common"
RDEPENDS:${PN} += " libpal libgpio-ctrl libobmc-sensors apml libnetlakenext-common"
